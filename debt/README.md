...
- [Runtime sqlx queries instead of compile-time macros](2026-05-05-runtime-sqlx-queries.md) — adopted because no per-test DB pre-UNK-70/UNK-97; lifts on UNK-167
